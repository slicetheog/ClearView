...
namespace SpotlightClean.ViewModel
{
    public class LauncherViewModel : BaseViewModel
    {
        ...
        public LauncherViewModel()
        {
            ...
            _searchTimer.Tick += async (s, e) => { _searchTimer.Stop(); await UpdateDisplayedResults(); }; // CHANGED: Make async
        ...
        private async Task UpdateDisplayedResults() // CHANGED: Restored full logic and made async Task
        {
        ...
        // CHANGED: Added default case to fix compiler warning
